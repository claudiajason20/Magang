...
Public Class Laporan_user
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_Tanah_GAC.Laporan_user.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_customer_id() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedLaporan_user
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Laporan_user = New Laporan_user()
        rpt.Site = Me.Site
        Return rpt
    End Function
