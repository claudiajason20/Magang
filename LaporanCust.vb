...
Public Class LaporanCust
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_Tanah_GAC.LaporanCust.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_cust_id() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedLaporanCust
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanCust = New LaporanCust()
        rpt.Site = Me.Site
        Return rpt
    End Function
